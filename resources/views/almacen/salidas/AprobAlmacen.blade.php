                ...
                <td> 
                  ...
                  <td> 
                    @if (auth()->user()->rol->nombre == 'Admin')
                      <form action="{{route('Rsalida.aprob.almacenista', $salida->id)}}" method="post">
                              @csrf
                              @method('put')
                              @if ($salida->estado == "Generada")
                               <input type="hidden" id="estado" name="estado" value="AprobadaAlmacenista">
                              @else
                                <input type="hidden" id="estado" name="estado" value="Generada">
                              @endif
                               ...
                               @endif
                               @if ($salida->estado == "AprobadaCoordAdm")
                               <p style="color:#FF0000";>Aprobada Coord Admin</p> 
                              @endif
